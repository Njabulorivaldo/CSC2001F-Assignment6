...
public class Graph
{
   ...
   /**
    *Geting the actual cost to the given destination node
    *return the actual cost if it is reachable and found
    *return -1 if the destination is unreachable
    *Throws a NoSuchElementException if destination vertex
   */
